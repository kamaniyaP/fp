...
const AnsModal = ({ isVisible, onClose, q_user_id, q_time }) => {
    ...
    useEffect(() => {
        ...
        if (Object.keys(textErrors).length === 0 && isSubmit) {
            console.log(textValues.textarea);
            textValues.q_id = q_user_id
            textValues.q_time = q_time
            textValues.a_id = localStorage.getItem("user_id")
            postData('/api/addAnswer', textValues).then(data => {
                ...
                <div className="bg-white p-2 rounded">
                    <div className="p-6">
                        ...
                        <div className="p-5 "><br />
                            <textarea name="textarea" placeholder="Start typing your answer"
                        ...
                        <div className="flex justify-center items-center">
                            ...
                            font-semibold hover:bg-blue-500 hover:text-white">Add answer</a>
                        </div>
                    </div>
